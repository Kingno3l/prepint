...
!(function (e, t) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(['exports'], t)
      : t(
        ((e = typeof globalThis !== 'undefined' ? globalThis : e || self).Popper = {}),
      );
}(this, (e) => {
  function t(e) {
  ...
  function E(e) {
    ...
    return i
      && (l(i) === 'html' || (l(i) === 'body' && m(i).position === 'static'))
      ? n
      : i
          || (function (e) {
  ...
  function _(e, t, o, s) {
    const f = t === 'clippingParents'
      ? (function (e) {
        const t = w(b(e));
        const o = ['absolute', 'fixed'].indexOf(m(e).position) >= 0 && r(e)
          ? E(e)
          : e;
        return n(o)
      ...
      var u = {
        ...
        forceUpdate() {
          if (!p) {
            ...
            if (Q(t, n)) {
              (f.rects = {
                reference: y(t, E(n), f.options.strategy === 'fixed'),
                popper: g(n),
              }),
              (f.reset = !1),
              (f.placement = f.options.placement),
              f.orderedModifiers.forEach((e) => (f.modifiersData[e.name] = {
    ...
    return (
      ...
      p
        ? ({
          ...
          ...(((R = {})[M] = O ? '0' : ''),
          (R[j] = w ? '0' : ''),
          (R.transform = (k.devicePixelRatio || 1) <= 1
            ? `translate(${y}px, ${b}px)`
      ...
      if (!t.modifiersData[r]._skip) {
        for (
          var o = n.mainAxis,
            ...
            b = [v].concat(g).reduce((e, n) => e.concat(
              F(n) === M
                ? ue(t, {
                  placement: n,
                  boundary: p,
  ...
  const he = {
    ...
    fn(e) {
      ...
      const T = typeof y === 'function'
        ? y({ ...t.rects, placement: t.placement })
        : y;
